package com.two_weeks_backend.two_weeks_backend.DTOs.entities.producto_manual;
...
@Getter
@Setter
public class ProductoManualUpdateDTO extends BaseUpdateDTO<ProductoEntity> {
    ...
    @NotNull(message = "La activacion es obligatoria")
